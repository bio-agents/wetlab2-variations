...
steps:
  - id: unzipped_known_sites
    ...
    out: [output]
    run: ../abstract_operations/gunzip_known_sites.cwl
  ...
  - id: gunzip
    ...
    out:
      - id: unzipped_fasta
    run: ../abstract_operations/gunzip.cwl

  - id: picard_dictionary
    # from samagents reference genome
    in:
      - id: reference_genome
        source:
    ...
    out:
      - id: dict
    run: ../abstract_operations/picard_dictionary.cwl
  ...
  - id: cutadapt2
    ...
    out: 
      - id: trimmed_fastq
    run: ../abstract_operations/cutadapt-v.1.18.cwl
  ...
  - id: bwa_index
    ...
    out:
      - id: output
    run: ../abstract_operations/bwa-index.cwl
  ...
  - id: samagents_index
    ...
    out:
      - id: index_fai
    run: ../abstract_operations/samagents_index.cwl
  ...
  - id: bwa_mem
    ...
    out:
      - id: aligned_sam
    run: ../abstract_operations/bwa-mem.cwl
  ...
  - id: samagents_sort
    ...
    out:
      - id: sorted_bam
    run: ../abstract_operations/samagents_sort_bam.cwl
   
  - id: picard_markduplicates
    in:
      - id: input
        source: 
          - samagents_sort/sorted_bam
    out:
      - id: md_bam
      - id: output_metrics
    run: ../abstract_operations/picard_markduplicates.cwl
    label: picard-MD
  ...
  - id: gatk3-rtc
    ...
    run: ../abstract_operations/gatk3-rtc.cwl
    label: gatk3-rtc
  ...
  - id: gatk-ir
    ...
    out:
      - id: realigned_bam
    run: ../abstract_operations/gatk-ir.cwl
    label: gatk-ir
  ...
  - id: gatk-base_recalibration
    ...
    out:
      - id: br_model 
    run: ../abstract_operations/gatk-base_recalibration.cwl
  ...
  - id: gatk-base_recalibration_print_reads
    ...
    out:
      - id: bqsr_bam
    run: ../abstract_operations/gatk-base_recalibration_print_reads.cwl
  ...
  - id: gatk_haplotype_caller
    ...
    out:
      - id: gvcf
    run: ../abstract_operations/gatk-haplotype_caller.cwl
