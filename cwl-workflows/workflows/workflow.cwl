...
steps:
  - id: unzipped_known_sites
    ...
    out: [output]
    run: ../agents/gunzip_known_sites.cwl
  ...
  - id: picard_dictionary
    ...
    out:
      - id: dict
    run: ../agents/picard_dictionary.cwl
  ...
  - id: cutadapt2
    ...
    out: 
      - id: trimmed_fastq
    run: ../agents/cutadapt-v.1.18.cwl
  ...
  - id: samagents_index
    ...
    out:
      - id: index_fai
    run: ../agents/samagents_index.cwl
  ...
  - id: samagents_sort
    ...
    out:
      - id: sorted_bam
    run: ../agents/samagents_sort_bam.cwl
  ...
  - id: gatk-base_recalibration
    ...
    out:
      - id: br_model 
    run: ../agents/gatk-base_recalibration.cwl
  ...
  - id: gatk-base_recalibration_print_reads
    ...
    out:
      - id: bqsr_bam
    run: ../agents/gatk-base_recalibration_print_reads.cwl
  ...
  - id: gatk_haplotype_caller
    ...
    out:
      - id: gvcf
    run: ../agents/gatk-haplotype_caller.cwl
